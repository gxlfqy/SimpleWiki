...
<body>
    ...
    <div class="mid_content">
        <div class="articleTheme">${entry_title}</div>
        <div class="title">
            <div class="article_title">文章标题</div>
            <textarea rows="3" placeholder="请输入文章标题(不大于80字)" maxlength="80" id="title-textarea"></textarea>
        </div>
...
<script src="${pageContext.request.contextPath}/res/js/addArticle.js"></script>
...
<script>
    ...
    $(".publish").click(function () {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: '${pageContext.request.contextPath}/entry/add/page',
